  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <span
          className={`px-3 py-1 rounded-full text-sm font-medium ${getComplianceStatusColor(complianceData.complianceStatus)}`}
        >
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 border rounded-lg">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2">
                  {complianceData.todoMdExists ? 'Yes' : 'No'}
                </span>
              </div>
            </div>
            <div className="flex items-center justify-between p-3 border rounded-lg">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2">
                  {complianceData.todoMdValid ? 'Yes' : 'No'}
                </span>
              </div>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 border rounded-lg">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2">
                  {complianceData.tasksMdHasCoverageRequirement
                    ? 'Present'
                    : 'Missing'}
                </span>
              </div>
      ...
      <div className="mt-6 pt-4 border-t">
        ...
        <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600">
          <li>
            TODO.md文件必须包含四个部分（待完成、待验证、已完成、任务详情）
          </li>
