          ...
          <div className="space-y-7">
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li>
                  <a
                    href="#"
                    className="block px-3 py-2 text-sm rounded-lg text-primary bg-blue-50 border-l-3 border-primary transition-colors"
                  >
                    全部分类
                  </a>
                </li>
                <li>
                  <a
                    href="#"
                    className="block px-3 py-2 text-sm rounded-lg text-text-gray hover:bg-blue-50 transition-colors"
                  >
                    技术
                  </a>
                </li>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors cursor-pointer">
                  编程
                </span>
                <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors cursor-pointer">
                  教程
