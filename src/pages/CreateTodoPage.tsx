...
const CreateTodoPage: React.FC = () => {
  const { todoFilePath, setTodoFilePath, isCreatingTodo, setCreatingTodo } =
    useComplianceStore();
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">
        Create Constitution-Compliant TODO.md
      </h1>
      ...
      <div className="bg-blue-50 rounded-lg p-6">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            The TODO.md file must contain four sections: 待完成, 待验证, 已完成,
            任务详情
          </li>
          <li>
            Each section must be in table format with headers: 任务ID, 简短描述,
            日期
          </li>
          <li>The file will be created at the project root by default</li>
          <li>
            File structure complies with project constitution requirements
          </li>
        </ul>
      </div>
    </div>
