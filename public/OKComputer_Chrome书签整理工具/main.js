...
function switchCategory(categoryKey) {
  ...
  if (category.bookmarks.length > 12) {
    ...
    moreCard.className =
      'bookmark-card bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl p-6 flex items-center justify-center text-center';
    moreCard.innerHTML = `
            <div>
...
function createBookmarkCard(bookmark, color) {
  ...
  card.className =
    'bookmark-card bg-white rounded-xl p-6 shadow-sm border border-gray-100';
